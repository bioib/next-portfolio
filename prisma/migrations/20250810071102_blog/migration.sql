...
-- CreateIndex
CREATE INDEX "Post_title_slug_idx" ON "public"."Post"("title", "slug");
...
-- CreateIndex
CREATE INDEX "Tag_name_slug_idx" ON "public"."Tag"("name", "slug");
...
-- AddForeignKey
ALTER TABLE "public"."Comment" ADD CONSTRAINT "Comment_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
